...
Last updated: 2026-09-06 — Phase 0 IA regroup: nav Home/Code/Create/Evolve/Connect/You, Eve label fix (ADR 0027 Proposed, merges pending sign-off)
...
## 6. Current snapshot
  ...
  - Loading: `WaveLoader` branded card (logo orbit ring + 7-bar wave + gradient progress, `detail` prop) + `LoadingState` ring icon + animated dots (token-only, reduced-motion safe).
