...
> **Last updated:** 2026-08-21 (Auto-remember: Eve auto-saves durable facts after every AI reply — chat, WhatsApp, calls, schedules — via one bounded extraction LLM call inside `chat_with_eve`; ON by default; `GET/PUT /settings/eve-memory` + new Settings "Eve memory" section toggle + command-palette entry)
