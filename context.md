...
Last updated: 2026-08-31 — Canonical domain starwaves.susindran.in + api.starwaves.susindran.in, vercel.app 308 redirect, FRONTEND_URL fix + ADR 0006
...
├── docs/adr/           ADRs (0001 no-sub-agents, 0002 eve-tool-calling, 0003 build scripts, 0004 auto-update, 0005 ai-provider-hardening, 0006 canonical-domain + _template + README)
