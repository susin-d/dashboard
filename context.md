...
Last updated: 2026-09-04 — Avatar UI fixes: companion drag via position ref (no stale closure), VRM mount effect uses ready-ref, VRM inline styles → eve-avatar.css
