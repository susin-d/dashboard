...
Last updated: 2026-09-06 — Jobs page now starts with a combined search/filter/add-job toolbar; application-frequency chart removed while pipeline status summary remains.
