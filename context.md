...
> **Last updated:** 2026-08-21 (AI models: added OpenRouter, Ollama (local, key-optional), OpenCode providers with shared OpenAI-compatible chat client + live `/v1/models` listing for all providers; EVE model dropdowns populated from provider APIs)
