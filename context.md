...
> **Last updated:** 2026-08-25 (Studio one-page layout — removed extra sections below the Studio prompt landing page; `StudioProjectsPage` and `StudioHero` now render cleanly as a single full-bleed, full-height creation view with AI badge, refined prompt card, multi-file attachments, and quick suggestion chips without any vertical page scrolling; lint/build OK)
