...
> **Last updated:** 2026-08-25 (Server reusable systems: `core/errors|http|pagination|dependencies|ws/base`, `repositories/helpers`, `models/mixins`, `db/sql/registry+base`, `api/routes/whatsapp/` package split, `services/helpers` pagination fetcher; WebSocket managers unified via BaseWSManager; auth DRY + SQL client registry-driven)
