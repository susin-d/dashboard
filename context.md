...
> **Last updated:** 2026-08-25 (Studio builder chat model selector — replaced the top-right `+` button in `.builder-chat-header` with an AI Model dropdown selector (`CustomDropdown`) with options for `GPT-5 mini`, `Gpt oss:120b`, `Claude 3.5 Sonnet`, `Gemini 1.5 Flash`, and `Llama 3.1`; lint/build OK)
