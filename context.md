...
Last updated: 2026-09-04 - Fix Avatar Studio CSS + performance (responsive grids, valid model cards, throttled eye/lip loops, paused renderers, debounced scale save)
