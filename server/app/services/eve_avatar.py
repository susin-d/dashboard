...
CATALOG = [
    {"id": "eve-mono-vrm", "label": "Eve Mono (VRM)", "renderer": "vrm", "url": "/avatars/vrm/eve-mono.vrm", "attribution": "CC0 - Starwaves Mono suit"},
    {"id": "eve-duo-vrm", "label": "Eve Duo (VRM)", "renderer": "vrm", "url": "/avatars/vrm/eve-duo.vrm", "attribution": "CC0 - Duo tinted variant"},
    {"id": "haru-live2d", "label": "Haru (Live2D)", "renderer": "live2d", "url": "/avatars/live2d/haru/Haru.model3.json", "attribution": "CC0 sample Live2D Haru"},
