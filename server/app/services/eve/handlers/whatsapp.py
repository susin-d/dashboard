...
def handle_list_whatsapp_chats(database: Client, user_id: str, arguments: dict) -> tuple[dict, None, None]:
...
def handle_read_whatsapp_messages(database: Client, user_id: str, arguments: dict) -> tuple[dict, None, None]:
    from app.repositories import whatsapp as wa_repo
...
def handle_send_whatsapp_message(database: Client, user_id: str, arguments: dict) -> tuple[dict, None, None]:
    from app.repositories import whatsapp as wa_repo
...
def handle_summarize_whatsapp_chat(database: Client, user_id: str, arguments: dict) -> tuple[dict, None, None]:
    from app.repositories import whatsapp as wa_repo
