...
export const navigationItems = [
  ...
  { id: 'studio', label: 'Studio', icon: Blocks, group: 'Create', module: 'studio' },
  ...
  { id: 'eve-sessions', label: 'Chat Sessions', icon: History, group: 'Evolve', module: 'eve' },
  { id: 'eve-memory', label: 'Eve Memory', icon: Brain, group: 'Evolve', module: 'eve' },
  { id: 'eve-call', label: 'Voice & AI Call', icon: PhoneCall, group: 'Evolve', module: 'eve' },
  { id: 'eve-schedules', label: 'Schedules & Reminders', icon: CalendarClock, group: 'Evolve', module: 'eve' },
  { id: 'avatar', label: 'Avatar Studio', icon: Smile, group: 'Evolve', module: 'eve' },
  { id: 'competitive-coding', label: 'Competitive Coding', icon: Code2, group: 'Evolve', module: 'growth' },
  { id: 'stats', label: 'Stats', icon: ChartNoAxesCombined, group: 'Evolve', module: 'growth' },
  ...
  { id: 'chats', label: 'Chats', icon: MessageSquare, group: 'Connect', module: 'chats' },
